...
This English edition uses familiar five-minute phrases: “ten past six,” “a quarter till three,” and “twelve o’clock.” The words round down to the current five-minute interval. The face updates once a minute and works offline.

Prose supports Basalt, Chalk, Diorite, Emery, Flint and Gabbro. Each display shape has its own spacing and type sizes. Monochrome watches use solid white lettering; color watches have softer gray connecting words. There are no settings or button controls.
...
Luke Steuber created Prose and its original [Spoken Prose clock](https://datapoems.io/clocks/dial-prose/). The supplied web source is preserved in `reference/source.html`; this native edition uses its English grammar and five-minute timing. The web version also includes other languages and palette controls.
